...
נשלח אליך קוד אימות למספר טלפון ${phone}, נא הקלידו את קוד האימות להשלמת הרישום
<form name="phoneVerificationForm" method="post" action="verifyPhone" data-ajax="false" data-transition="pop" id="phoneVerificationForm" style="display:inline;" onsubmit="return ValidateForm1(this)">
